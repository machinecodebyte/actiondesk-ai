      ...
      <section className="mx-auto grid min-h-[calc(100vh-4rem)] max-w-6xl content-center gap-10 lg:grid-cols-[1.1fr_0.9fr]">
        <div className="flex flex-col justify-center">
          ...
          <p className="mt-5 max-w-2xl text-lg leading-8 text-slate-600">
            Turn Gmail and Google Calendar into an AI-powered command center.
            Start with a secure workspace, then connect your sources through Corsair.
          </p>
        ...
        <Card className="self-center">
          <CardBody className="space-y-5">
            <div>
              ...
              <h2 className="mt-1 text-2xl font-semibold text-ink">Connect before commands</h2>
            </div>
